...
const TOKEN = {
  ...
  white: '#FFFFFF',
  offWhite: '#F7F6F3',
  accent: '#D4AF37',          // gold accent for religious
  accentDark: '#B8942E',
  muted: '#6B6B6B',
  ...
  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
    ...
    >
      ...
      <Typography sx={{ fontFamily: TOKEN.fontBody, color: TOKEN.muted, fontSize: '0.9rem', maxWidth: 340 }}>
        No products in the Religious collection yet. Check back soon.
      </Typography>
    </Box>
  </motion.div>
);
