...
const TOKEN = {
  ...
  white: '#FFFFFF',
  offWhite: '#F7F6F3',
  accent: '#C8FF00',          // electric chartreuse — the brand moment
  accentDark: '#9FCC00',
  muted: '#6B6B6B',
...
/** Animated section header with editorial feel */
const PageHeader = () => (
  <motion.div
  ...
  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
    ...
    >
      ...
      <Typography sx={{ fontFamily: TOKEN.fontBody, color: TOKEN.muted, fontSize: '0.9rem', maxWidth: 340 }}>
        No products in the Sport collection yet. Check back soon.
      </Typography>
    </Box>
  </motion.div>
);
